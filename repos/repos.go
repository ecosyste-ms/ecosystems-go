...
type Host struct {
	...
	RobotsTxtUpdatedAt *time.Time `json:"robots_txt_updated_at"`
...
func NewGetHostOwnersRequest(server string, hostName string, params *GetHostOwnersParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.HasSponsorsListing != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "has_sponsors_listing", runtime.ParamLocationQuery, *params.HasSponsorsListing); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewUsagePackageDependentRepositoriesRequest(server string, ecosystem string, pPackage string, params *UsagePackageDependentRepositoriesParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.MinStars != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "min_stars", runtime.ParamLocationQuery, *params.MinStars); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
